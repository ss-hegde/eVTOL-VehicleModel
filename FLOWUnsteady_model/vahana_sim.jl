...
include(joinpath("vahana_vehicle.jl"))
include(joinpath("vahana_maneuver.jl"))
include(joinpath("vahana_monitors.jl"))
...
# Reference lengths
k = 0.1301
R               = 0.75 * k                      # (m) reference blade radius
...
maneuver, Vvehicle(t), anglevehicle(t) = generate_maneuver_vahana(; add_rotors=add_rotors)
...
monitors = generate_monitor_vahana(vehicle, rho, RPMref, nsteps,
                                         save_path, Vinf, AOA, orientation_wing,
                                         anglevehicle, Vvehicle;
                                         add_wings=add_wings,
