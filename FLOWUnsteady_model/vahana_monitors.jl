...
"""
function generate_monitor_vahana(vehicle, rho, RPMref, nsteps, save_path, Vinf, AOA,
                                    orientation_wing, anglevehicle, Vvehicle;
                                                        add_wings=true,
                                                        wingmonitor_optargs=[])
    ...
    if add_wings
        ...
        mainwing_monitor = uns.generate_monitor_wing(mainwing_system, Vinf, b_ref, ar_ref,
                                                        rho, qinf, AOA, orientation_wing, anglevehicle,
                                                        Vvehicle, nsteps;
