...
function generate_eMagicOne_vehicle(;
    ...
    x_pos_w           = 4.505 * k             # (m) position of the wing in the x-direction
    y_pos_w           = 0.0 * k               # (m) position of the wing in the y-direction
    z_pos_w           = -0.2 * k              # (m) position of the wing in the z-direction
    ...
    x_pos_c           = 1.14 * k                  # (m) position of the wing in the x-direction
    y_pos_c           = 0.0 * k                   # (m) position of the wing in the y-direction
    z_pos_c           = 0.35 * k                  # (m) position of the wing in the z-direction
    ...
    RPM             = 2000                      # RPM
    J               = 0.001                      # Advance ratio Vinf/(nD)
    AOA             = 5.0                         # (deg) Angle of attack (incidence angle)
    ...
    canard_axis = uns.gt.rotation_matrix(0.0, -1.0, 0.0)
